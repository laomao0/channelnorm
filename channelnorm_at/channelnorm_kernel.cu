...
void channelnorm_kernel_forward(
    ...
    // printf("forward");
    // printf("n %d:", n);
    // printf("input1 size, %d, %d, %d, %d", input1.size(0), input1.size(1), input1.size(2), input1.size(3));
    // printf("input1 stride, %d, %d, %d, %d", input1.stride(0), input1.stride(1), input1.stride(2), input1.stride(3));
    // printf("output size, %d, %d, %d, %d", output.size(0), output.size(1), output.size(2), output.size(3));
    // printf("output stride, %d, %d, %d, %d", output.stride(0), output.stride(1), output.stride(2), output.stride(3));
...
void channelnorm_kernel_backward(
    ...
    // printf("output size, %d, %d, %d, %d", output.size(0), output.size(1), output.size(2), output.size(3));
    // printf("output stride, %d, %d, %d, %d", output.stride(0), output.stride(1), output.stride(2), output.stride(3));
    // printf("gradoutput size, %d, %d, %d, %d", gradOutput.size(0), gradOutput.size(1), gradOutput.size(2), gradOutput.size(3));
    // printf("gradoutput stride, %d, %d, %d, %d", gradOutput.stride(0), gradOutput.stride(1), gradOutput.stride(2), gradOutput.stride(3));
    // printf("gradinput1 size, %d, %d, %d, %d", gradInput1.size(0), gradInput1.size(1), gradInput1.size(2), gradInput1.size(3));
    // printf("gradinput1 stride, %d, %d, %d, %d", gradInput1.stride(0), gradInput1.stride(1), gradInput1.stride(2), gradInput1.stride(3));
